...
In order to support loading of multiple wallets in mire-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mire.cpp.
...
Changes to mire.cpp
----------------------
mire.cpp is the entry point into mire-qt, and as such, will require some minor modifications to provide hooks for
