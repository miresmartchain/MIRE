                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mire Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mire address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mire: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMIRE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mire Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mire Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mire"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mire addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mire addresses"));
    ...
    openAction->setStatusTip(tr("Open a Mire: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mire Core help message to get a list with possible Mire command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mire Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mire network", "", count));
}
...
{
    QString strTitle = tr("Mire Core"); // default title
