...
public:
    ...
    void setupUi(QMainWindow *BlockExplorer)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1194, 607));
        ...
        content->setStyleSheet(QStringLiteral("background-color: transparent"));
        ...
        menubar->setGeometry(QRect(0, 0, 1214, 27));
