                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Mire from zMire"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMire"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMire));
