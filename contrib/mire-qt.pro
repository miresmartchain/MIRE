...
RESOURCES += src/qt/mire.qrc src/qt/mire_locale.qrc

TRANSLATIONS += src/qt/locale/mire_bg.ts \
                src/qt/locale/mire_de.ts \
                src/qt/locale/mire_en.ts \
                src/qt/locale/mire_es.ts \
                src/qt/locale/mire_fi.ts \
                src/qt/locale/mire_fr.ts \
                src/qt/locale/mire_it.ts \
                src/qt/locale/mire_ja.ts \
                src/qt/locale/mire_pl.ts \
                src/qt/locale/mire_pt.ts \
                src/qt/locale/mire_ru.ts \
                src/qt/locale/mire_sk.ts \
                src/qt/locale/mire_sv.ts \
                src/qt/locale/mire_vi.ts \
                src/qt/locale/mire_zh_CN.ts \
                src/qt/locale/mire_zh_TW.ts
