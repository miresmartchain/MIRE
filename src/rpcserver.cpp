...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mire features */
        {"mire", "masternode", &masternode, true, true, false},
        {"mire", "listmasternodes", &listmasternodes, true, true, false},
        {"mire", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mire", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mire", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mire", "masternodedebug", &masternodedebug, true, true, false},
        {"mire", "startmasternode", &startmasternode, true, true, false},
        {"mire", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mire", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mire", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mire", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mire", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mire", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mire", "mnbudget", &mnbudget, true, true, false},
        {"mire", "preparebudget", &preparebudget, true, true, false},
        {"mire", "submitbudget", &submitbudget, true, true, false},
        {"mire", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mire", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mire", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mire", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mire", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mire", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mire", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mire", "checkbudgets", &checkbudgets, true, true, false},
        {"mire", "mnsync", &mnsync, true, true, false},
        {"mire", "spork", &spork, true, true, false},
        {"mire", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mire", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mired, or the -server option to mire-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mire-cli " + methodname + " " + args + "\n";
}
